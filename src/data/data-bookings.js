...
function fromToday(numDays, withTime = false) {
  const date = add(new Date(), { dias: numDays });
...
export const contratos = [
  ...
  // CABIN 006
  {
    ...
    hasBreakfast: false,
    observations:
      "We will be iniciog in late, around midnight. Hope that's okay :)",
    isPaid: true,
    numClientes: 6,
  },
  {
    ...
    clienteId: 18,
    hasBreakfast: true,
    observations: "I will need a rollaway bed for one of the clientes",
    isPaid: true,
    numClientes: 4,
  },
  {
